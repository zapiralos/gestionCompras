...
CREATE TABLE `gestion` (
  ...
  `tipo_de_gestion` int(11) NOT NULL,
...
CREATE TABLE `medicamentos` (
  ...
  KEY `medicamentos_FK_1` (`gestion_id`),
  CONSTRAINT `medicamentos_FK` FOREIGN KEY (`id_estado`) REFERENCES `estado` (`id`),
  CONSTRAINT `medicamentos_FK_1` FOREIGN KEY (`gestion_id`) REFERENCES `gestion` (`id`)
...
CREATE TABLE `protesis` (
  ...
  KEY `protesis_FK_1` (`gestion_id`),
  CONSTRAINT `protesis_FK` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedor` (`id`),
  CONSTRAINT `protesis_FK_1` FOREIGN KEY (`gestion_id`) REFERENCES `gestion` (`id`)
...
-- Dump completed on 2021-04-19 12:33:21
